...
*/
	...
	// for now all presets have color
	color = true;
	if (filmName == "Advantix_100CD") {
		...
		color = true;
	} else if (filmName == "Kodachrome_25") {
		const size_t nRed = sizeof(Kodachrome_25Red_I) / sizeof(Kodachrome_25Red_I[0]);
		RedI.assign(Kodachrome_25Red_I, Kodachrome_25Red_I + nRed);
		RedB.assign(Kodachrome_25Red_B, Kodachrome_25Red_B + nRed);
		const size_t nGreen = sizeof(Kodachrome_25Green_I) / sizeof(Kodachrome_25Green_I[0]);
		GreenI.assign(Kodachrome_25Green_I, Kodachrome_25Green_I + nGreen);
		GreenB.assign(Kodachrome_25Green_B, Kodachrome_25Green_B + nGreen);
		color = true;
