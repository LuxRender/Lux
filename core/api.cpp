...
extern "C" void luxSaveEXR(const char* name, const bool &useHalfFloat, const bool &includeZBuffer, const int &compressionType)
{
	Context::GetActive()->SaveEXR(string(name), useHalfFloat, includeZBuffer, compressionType);
}
