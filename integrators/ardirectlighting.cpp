...
ARDirectLightingIntegrator::ARDirectLightingIntegrator(u_int md) : SurfaceIntegrator() {
	maxDepth = md;
...
u_int ARDirectLightingIntegrator::LiInternal(const Scene &scene,
...
u_int ARDirectLightingIntegrator::Li(const Scene &scene,
