...
compiled with Visual Studio 2005 and are intended for use in other
programs compiled with VS 2005.  

If you are using Visual Studio .NET 2003, you cannot link your
...
of OpenEXR for Visual Studio .NET 2003, if we have provided one.
