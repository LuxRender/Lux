...
void HybridMultiHashGrid::AddFlux(const Point &hitPoint, const u_int passIndex, const BSDF &bsdf, const Vector &wi,
	...
	if (hc2)
		hc2->AddFlux(this, passIndex, hitPoint, bsdf, wi, sw, photonFlux, light_group);
	/*else
		return;
