 ...
 */
#if (!defined(HAVE_ALTIVEC)) && (!defined(LUX_USE_SSE))
#ifdef ONLY64
...
void fill_array32(uint32_t *array, int size) {
    BOOST_ASSERT(initialized);
    BOOST_ASSERT(idx == N32);
    BOOST_ASSERT(size % 4 == 0);
    BOOST_ASSERT(size >= N32);
