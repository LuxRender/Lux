...
class SRTBBStatistics : public RendererStatistics {
public:
	SRTBBStatistics(SamplerTBBRenderer* renderer);
	~SRTBBStatistics();

	class FormattedLong : public RendererStatistics::FormattedLong {
	public:
		FormattedLong(SRTBBStatistics* rs);
	...
	private:
		...
		friend class SRTBBStatistics::FormattedShort;
	};

	class FormattedShort : public RendererStatistics::FormattedShort {
	public:
		FormattedShort(SRTBBStatistics* rs);
...
private:
	...
	virtual u_int getThreadCount() { return renderer->numberOfThreads; }
