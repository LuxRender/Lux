...
#
# --------------------------------------------------------------------------
# LuxBlend v0.1 alpha10 exporter
# --------------------------------------------------------------------------
#
# Authors:
...
def save_lux(filename, unindexedname):
	...
	file.write("# Exported by LuxBlend_01_alpha10\n")
...
##################
	...
	BGL.glColor3f(0.9,0.9,0.9);BGL.glRasterPos2i(10,205) ; Draw.Text("LuxBlend v0.1alpha10", "small")
