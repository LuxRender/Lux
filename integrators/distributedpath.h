...
public:
	...
	DistributedPath(LightStrategy st, bool da, u_int ds, bool dd, bool dg,
		bool ida, u_int ids, bool idd, bool idg,
		u_int drd, u_int drs, u_int dtd, u_int dts,
		u_int grd, u_int grs, u_int gtd, u_int gts,
		u_int srd, u_int std,
...
private:
	...
	void Reject(const TsPack *tspack, vector< vector<SWCSpectrum> > &LL,
